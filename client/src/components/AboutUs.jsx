    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {['Innovation', 'Accessibility', 'Excellence'].map((value, index) => (
                        ...
                        >
                            <h3 className="text-2xl font-bold text-orange-500 mb-4">{value}</h3>
                            <p className="text-black-300">
                                {value === 'Innovation' && 'Pushing boundaries in educational technology to create groundbreaking learning experiences.'}
                                {value === 'Accessibility' && 'Making quality education available to everyone, everywhere through VR technology.'}
                                {value === 'Excellence' && 'Committed to delivering the highest quality educational content and experiences.'}
                            </p>
                        </motion.div>
                    ))}
                </div>
            ...
            <motion.div 
                ...
                animate="visible"
            >
                <h2 className="text-4xl font-bold text-black text-center mb-12">Our Development Team</h2>
