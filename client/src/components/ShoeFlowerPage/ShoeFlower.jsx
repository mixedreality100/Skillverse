...
export const ShoeFlower = () => {
  ...
  if (navigateToCustardApple) {
    return <Navigate to="/cluster-fig" />;  // Navigate to Custard Apple page when the button is clicked
  }
    ...
    <div className="bg-[#FFFFFF] flex justify-center items-center w-full min-h-screen">
      <div className="max-w-[1440px] w-full">
        ...
        <div className="bg-[#FFFFFF] overflow-hidden w-[1440px] h-[4853px] relative">
          ...
          <div className="absolute w-full h-[114px] top-[1437px] bg-[#F7A8B0]">
          ...
          <div className="absolute w-[1440px] h-[114px] top-[2306px] bg-[#F9B6C1]">
          ...
          <div className="absolute w-[1440px] h-[114px] top-[3192px] bg-[#F9B6C1]">
          ...
          <section className="takequiz">
            <div className="absolute w-[1440px] h-[114px] top-[3996px] bg-[#F7A8B0]">
          ...
          <p className="absolute w-[618px] top-[1619px] left-[43px] [font-family:'Poppins',Helvetica] font-bold text-[#063229] text-[35px] tracking-[0] leading-[35.3px]">
           ...
           Hibiscus: Nature's Bright Healer
          </p>
          ...
          <section id="3d-model" className="absolute w-[486px] top-[1683px] left-[71px]">
            <div className="[font-family:'Poppins',Helvetica] font-normal text-[#063229] text-[22px] text-justify tracking-[0] leading-[35px]">
              ...
              <span className="[font-family:'Poppins',Helvetica] font-normal text-[#025169] text-[18px] tracking-[0] leading-[35px]">
              Welcome to the world of Hibiscus, a plant so vibrant it's been celebrated as 'Nature's Colorful Healer'! Get ready to embark on an exciting adventure where you'll discover the beauty of this unique flower and its incredible medicinal properties.
              <br />
                <br />
              </span>
  ...
  <div className="absolute top-[125px] left-[250px] [font-family:'Bebas_Neue',Helvetica] font-light text-[#94B5A0] text-[320px] text-center tracking-[10.71px] leading-[400px] max-w-full">
    <span className="text-[#8A3333]">HIBIS</span><span className="text-[#0A342A]">CUS</span>
  </div>

            <div className="absolute top-[575px] left-[1050px] [font-family:'Times_New_Roman-Italic',Helvetica] font-bold italic text-black text-[29px] text-center tracking-[2.34px] leading-[normal] whitespace-nowrap">
          ...
          <div className="absolute w-full h-[869px] top-[1437px] left-0">
            <Canvas camera={{ position: [4.966105677506236, 4.368993204971594, 2.8195141497543568], fov: 45 }} shadows>
...
export default ShoeFlower; // Ensure default export