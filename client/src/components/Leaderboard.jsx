    ...
    <div className="flex flex-row justify-center w-full bg-white">
      <div className="bg-[#ffffff] overflow-x-hidden w-full max-w-[1440px] relative rounded-lg">
        ...
        <div className="relative w-full px-4 md:px-8 lg:w-[1426px]">
          ...
          {isMobileMenuOpen && (
            <div className="md:hidden absolute top-[80px] right-[20px] z-30 bg-white shadow-lg rounded-lg p-4 w-[200px]">
              <div className="flex flex-col space-y-4">
                <NavButton
                  path="#courses"
                  className="px-4 py-2 whitespace-nowrap bg-zinc-50 rounded-[100px] text-sm text-black transform transition-transform duration-300 hover:scale-110"
                  style={{
                    boxShadow: "5px 5px 10px #d1d1d1, -5px -5px 10px #ffffff",
                    border: "0.5px solid rgba(0, 0, 0, 0.1)",
                  }}
          ...
          {/* Desktop Navigation */}
          <div className="hidden md:flex md:gap-4 lg:gap-16 ml-[32%] py-[45px]">
            <NavButton
              path="#courses"
        ...
        {/* Leaderboard Section */}
        <div className="relative mt-[120px] md:mt-[150px] lg:mt-[50px] mx-4 sm:mx-[30px] md:mx-[40px] lg:mx-[50px] w-auto max-w-full lg:w-[93%]">
          <div>
            <style>
              {`
                @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600&family=Paytone+One&display=swap');
              `}
            </style>
            <div
              className="text-center text-[#000000] text-4xl sm:text-5xl md:text-6xl lg:text-[70px] xl:text-[100px] font-bold mb-4"
              style={{ fontFamily: "Poppins, sans-serif", marginTop: "6" }}
            >
              Leaderboard
            </div>
          </div>
            ...
            >
              <thead>
                <tr className="bg-gray-200">
                  <th
                    className="border border-gray-400 px-2 sm:px-4 md:px-6 lg:px-8 py-2 sm:py-3 md:py-4"
        ...
        {/* Footer section - Made responsive with Logo Images */}
          ...
          <div className="relative w-full h-[300px] sm:h-[350px] md:h-[400px] lg:h-[440px] bg-[url('https://cdn.animaapp.com/projects/66fe7ba2df054d0dfb35274e/releases/676d6d16be8aa405f53530bc/img/hd-wallpaper-anatomy-human-anatomy-1.png')] bg-cover">
            <div className="absolute top-[180px] sm:top-[210px] md:top-[230px] lg:top-[252px] left-[10px] sm:left-[15px] md:left-[20px] lg:left-[23px] right-[10px] sm:right-[15px] md:right-[20px] lg:right-[23px] h-[150px] sm:h-[160px] md:h-[170px] lg:h-[178px] bg-white rounded-[12px]">
              <div className="flex flex-wrap justify-center gap-2 sm:gap-3 md:space-x-4 mt-4">
                {/* Instagram Button */}
                <button
                  className="w-36 sm:w-40 md:w-44 lg:w-48 h-9 sm:h-10 lg:h-11 bg-white border border-black rounded-full hover:bg-gradient-to-r hover:from-pink-500 hover:via-purple-500 hover:to-yellow-500 hover:text-white hover:scale-105 transition duration-200 flex items-center justify-center"
                  style={{
                    boxShadow: "5px 5px 10px #d1d1d1, -5px -5px 10px #ffffff",
                    border: "0.5px solid rgba(0, 0, 0, 0.1)",
                  }}
                ...
                {/* Twitter Button */}
                <button
                  className="w-36 sm:w-40 md:w-44 lg:w-48 h-9 sm:h-10 lg:h-11 bg-white border border-black rounded-full hover:bg-black hover:text-white hover:scale-105 transition duration-200 flex items-center justify-center"
                  style={{
                    boxShadow: "5px 5px 10px #d1d1d1, -5px -5px 10px #ffffff",
                    border: "0.5px solid rgba(0, 0, 0, 0.1)",
                  }}
                ...
                {/* Facebook Button */}
                <button
                  className="w-36 sm:w-40 md:w-44 lg:w-48 h-9 sm:h-10 lg:h-11 bg-white border border-black rounded-full hover:bg-blue-500 hover:text-white hover:scale-105 transition duration-200 flex items-center justify-center"
                  style={{
                    boxShadow: "5px 5px 10px #d1d1d1, -5px -5px 10px #ffffff",
                    border: "0.5px solid rgba(0, 0, 0, 0.1)",
                  }}
                ...
                {/* Pinterest Button */}
                <button
                  className="w-36 sm:w-40 md:w-44 lg:w-48 h-9 sm:h-10 lg:h-11 bg-white border border-black rounded-full hover:bg-red-100 hover:text-white hover:scale-105 transition duration-200 flex items-center justify-center"
                  style={{
                    boxShadow: "5px 5px 10px #d1d1d1, -5px -5px 10px #ffffff",
                    border: "0.5px solid rgba(0, 0, 0, 0.1)",
                  }}
